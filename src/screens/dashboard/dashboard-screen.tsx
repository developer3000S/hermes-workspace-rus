...
// `IconSvgObject` не экспортируется из @hugeicons/react; используем
// выведенный тип из реального импорта иконки для типизации пропсов.
    ...
    <div className="min-h-full">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex w-full flex-wrap items-center justify-end gap-2 lg:max-w-xl">
          ...
          <button
            type="button"
            aria-label={layout.editMode ? 'Готово' : 'Изменить макет'}
            title={layout.editMode ? 'Готово' : 'Изменить макет'}
